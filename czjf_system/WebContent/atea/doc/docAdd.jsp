...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
            function up()
		    {
	            ...
	            pop.setContent("contentUrl","/czjf_system/upload/upload.jsp");
	...
	<body leftmargin="2" topmargin="9" background='/czjf_system/images/allbg.gif'>
			<form action="/czjf_system/atea/doc/docMana.jsp" name="form1" method="post" enctype="multipart/form-data">
