  ...
  <div id="wrapper">
      ...
      <div id="right">
	      ...
	      <div id="welcome">
					...
					<c:forEach items="${list}"  var="v">
	                    <div class="c1-bline" style="padding:7px 0px;">
			                    <div class="f-left">
			                          ...
			                          <a href="${pageContext.request.contextPath}/VideoServlet?method=findVedioByVid&id=${v.vedioId}"  class="pn-loperator" <!-- style="color: red" -->>
			                             ${v.vedioName}
			                          </a>
			                     </div>
	        ...
	        <p class="more"><a href="${pageContext.request.contextPath}/VideoServlet?method=findVedioWithPage&num=1">more</a></p>
